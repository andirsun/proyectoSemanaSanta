...
class MainActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_main)//carga la vista que quiero mostrar en esta activoida
    ...
    fun login(view: View)
    {
        ...
        {
            val intent = Intent(this, UsersListActivity::class.java) ///esto me redirige a la vista o layout de os usuarios
